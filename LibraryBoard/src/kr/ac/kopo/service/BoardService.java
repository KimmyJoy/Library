...
public class BoardService {
	...
	public void insertBoard(BookVO book) {
	...
	*/ 
		bookdao.insertBoard(book);//위 항목이 추가된 것을 boardDao에 넘겨주는 것
	}
	...
	public BookVO selectByNo(int barcode) {
		BookVO book = bookdao.selectByBarcode(barcode);//해당번호에 대한 게시글을 얻어오려는 것
		return book;
	}
