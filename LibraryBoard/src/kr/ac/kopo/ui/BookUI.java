...
public class BookUI extends BaseUI {//BaseUI클래스를 상속받고, ILibraryUI 인터페이스를 상속받음....근데 모든 ui가 익스큐트를 써야한다는 점을 생각하면 BaseUI가 IBoardUI인터페이스 상속받으면 BaseUI만 하면 그만 아닐까?
//이건 무조건 관리자만!!!!!! 접근 가능한거여야....
	private int menu() {
		System.out.println("================================== 도서 관리 프로그램 ==================================");
		System.out.println("[1] 전체 도서 조회\t[2] 도서 검색\t[3] 도서 등록\t[4] 도서 삭제");
	...
	public void execute() throws Exception {//메뉴가 나오고 메뉴를 항목에서 선택하게 만들어줘야할 것 위를 프라이빗으로 두기 위해 메소드를 따로 뺀것
		while(true){
			...
			case 2:
				...
				break;
			case 3:
				ui = new AddBookUI();//원래는 글등록이있었는데 여기를 우리가 만든 클래스 메소드로 대체
